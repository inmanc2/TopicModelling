...
```{r}
set.seed(2021)
tweet_lda <- topicmodels::LDA(tweet_dtm, k = 6, method = "VEM")
tweet_lda
```
...
Then, to demonstrate, we subjectively decide to focus on the top 10 words in the 8 topics. We use the split-apply-combine pattern by clustering the words by topic (“split”), indicating the top 10 words (“apply”), and then use ungroup() to remove the grouping variable (“combine”).
